...
internal object GitHubApiEndpoints {
    ...
    fun organizationTeam(org: String, slug: String) = "/orgs/$org/teams/$slug"
    fun organizationTeamMembers(org: String, slug: String) = "/orgs/$org/teams/$slug/members"
    fun organizationTeamMembership(org: String, slug: String, username: String) =
        "/orgs/$org/teams/$slug/memberships/$username"
    fun organizationTeamRepositories(org: String, slug: String) = "/orgs/$org/teams/$slug/repos"
     ...
     */
    fun organizationTeamRepository(org: String, slug: String, repoOwner: String, repo: String) =
        "/orgs/$org/teams/$slug/repos/$repoOwner/$repo"

    // Repositories
    fun repository(owner: String, repo: String) = "/repos/$owner/$repo"
    fun repositoryTeams(owner: String, repo: String) = "/repos/$owner/$repo/teams"
    fun repositoryCollaborators(owner: String, repo: String) = "/repos/$owner/$repo/collaborators"
    fun repositoryTransfer(owner: String, repo: String) = "/repos/$owner/$repo/transfer"
}
